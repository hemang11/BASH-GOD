...
@since 1.0
@requires
tool | service:kubectl | present
@description
Lists pod names, readiness, status, restart counts, and age in one namespace.
@run
kubectl get pods -n <namespace>
@params
-n | <namespace> | Namespace containing the pods
@optional
-l | app=<label_value> | Show only pods matching this label selector
@end
...
@optional
-l | app=<label_value> | Watch only pods matching this label selector
@notes
...
-n | <namespace> | Namespace containing the pod
@end
...
-n | <namespace> | Namespace containing the deployment
@end
...
-n | <namespace> | Namespace containing the service
@end
...
@params
-l | app=<label_value> | Label selector identifying the pods
-n | <namespace> | Namespace containing the pods
...
@params
-n | <namespace> | Namespace containing the ConfigMaps
@end
...
-n | <namespace> | Namespace containing the ConfigMap
@end
...
@params
-n | <namespace> | Namespace whose recent events should be listed
@notes
...
@params
-n | <namespace> | Namespace whose events should be listed
...
@params
-n | <namespace> | Namespace whose warning events should be listed
...
@params
-n | <namespace> | Namespace containing the deployments
@end
...
@params
-n | <namespace> | Namespace containing the services
@end
...
@params
-n | <namespace> | Namespace containing the EndpointSlices
@optional
...
@params
-n | <namespace> | Namespace containing the Endpoints objects
@notes
...
@params
-n | <namespace> | Namespace containing the ingresses
@end
