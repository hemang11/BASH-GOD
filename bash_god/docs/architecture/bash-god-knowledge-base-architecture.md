...
**Status:** Implemented in BASH_GOD 0.0.2.4. Reviewed execution is now generic across the current
service catalogs.
...
it can never run a line it contains. In BASH_GOD 0.0.2.4, the *value* of one reviewed `@run` line is
...
`BASH_GOD 0.0.2.4` and `License: MIT`; they do not report the host shell version.
